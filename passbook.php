...
?>
 <div class="container">
    <div class="row ml-2">
    <h2 style="font:Arial;color: #2e2e2e;text-align:center"><b>PROFILE</b></h2>
    </div>
    <div class="row mb-3">
    <div class="col-md-4">
...
if(mysqli_num_rows($res) !=0)
{
   ...
   <div class="container text-center">
    <h2 style="font:Arial;color: #2e2e2e;text-align:center"><b>TRANSACTION DETAILS</b></h2>
    <br>
    ...
    <thead class="thead-blue" style="background-color: #13205d">
      <tr>
        <th scope="col" style="color: #ffffff" colspan="3">SENDER</th>
    
        <th scope="col" style="color: #ffffff" colspan="3">RECEIVER</th>
        
        <th scope="col" style="color: #ffffff" rowspan="2">TRANSECTION AMOUNT</th>
