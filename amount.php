...
<link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css" integrity="sha384-ggOyR0iXCbMQv3Xipma34MD+dH/1fQ784/j6cY/iJTQUOhcWr7x9JvoRxT2MZw1T" crossorigin="anonymous">
    ...
    .msg
 {
  ...
  <h2 style="font:Arial;color: #2e2e2e;text-align:center"><b>SENDER'S DETAILS</b></h2>
  
  <div class="card border-dark" style="width: 25rem ;background-color:#ffb2b2">
    <div class="card-body">
  ...
  ?>
  <div class='col-md-4'>
  <h2 style="font:Arial;color: #2e2e2e;text-align:center"><b>RECEIVER'S DETAILS</b></h2>
  
  
  <div class="card border-dark" style="width: 25rem ;background-color:#b3ffb2">
    <div class="card-body">
  ...
  ?>
        ...
        <h2 style="font:Arial;color: #2e2e2e;text-align:center"><b>ENTER AMOUNT</b></h2>
        </div>
        <div class="row align-items-center justify-content-center">
